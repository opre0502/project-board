...
class Ex11_6_ArticleControllerTest {
    ...
    /* @MockBean: 테스트시 테스트에 필요한 객체를 Bean으로 등록 시켜서 기존객체 대신 사용할수 있게 만들어줌

    ArticleController 에 있는 private final ArticleService articleService; 부분의 articleService 를 배제하기 위해서 @MockBean 사용함. 이유는 MockMvc 가 입출력 관련된 것들만 보게 하기 위해서 진짜 서비스 로직을 끊어주기 위해서 @MockBean 사용
